...
Eigen::Vector4d current_state_(4.5,-3.0,0.0,0.0);
...
void StatesCallback(const gazebo_msgs::ModelStates &box_state_current)
{
    ...
    ROS_INFO("traval distance of tb3_2: %f !", trajecty_sum_);
...
{
  ros::init(argc, argv, "tb3_2_moniter_node");
