...
Eigen::Vector4d current_state_(-3.5,0.0,0.0,0.0);
...
void StatesCallback(const gazebo_msgs::ModelStates &box_state_current)
{
    ...
    ROS_INFO("traval distance of tb3_3: %f !", trajecty_sum_);
...
{
  ros::init(argc, argv, "tb3_3_moniter_node");
