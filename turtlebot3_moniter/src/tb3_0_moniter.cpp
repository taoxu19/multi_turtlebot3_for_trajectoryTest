...
Eigen::Vector4d current_state_(4.5,2.0,1.0,0.0);
...
void StatesCallback(const gazebo_msgs::ModelStates &box_state_current)
{
    ...
    ROS_INFO("traval distance of tb3_0: %f !", trajecty_sum_);
...
{
  ros::init(argc, argv, "tb3_0_moniter_node");
